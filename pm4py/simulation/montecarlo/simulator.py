...
def apply(log, net, im, fm, variant=DEFAULT_VARIANT, parameters=None):
    ...
    parameters
        Parameters of the algorithm:
            ...
            Parameters.PARAM_CASE_ARRIVAL_RATIO => Case arrival of new cases (default: None; inferred from the log_skeleton)
            Parameters.PARAM_PROVIDED_SMAP => Stochastic map that is used in the simulation (default: None; inferred from the log_skeleton)
